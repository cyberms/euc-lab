...
source "vsphere-iso" "windows_server_22" {
  # vcenter settings
  ...
  # # boot / shutdown settings SSH
  # communicator            = "ssh"
  # ssh_password          = "${var.winadmin-password}"
...
build {
  sources = ["source.vsphere-iso.windows_server_22"]
